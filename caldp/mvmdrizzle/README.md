...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/mvmdrizzle/latest-linux.yml
$ conda env create -n caldp_mvmdrizzle --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_mvmdrizzle
```
