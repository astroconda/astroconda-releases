...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20200708/latest-linux.yml
$ conda env create -n caldp_20200708 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20200708
```
