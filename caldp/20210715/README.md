...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20210505/latest-linux.yml
$ conda env create -n caldp_20210505 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20210505
```
