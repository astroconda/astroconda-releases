...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/copyleft/latest-linux.yml
$ conda env create -n caldp_copyleft --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_copyleft
```
