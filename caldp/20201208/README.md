...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20201208/latest-linux.yml
$ conda env create -n caldp_20201208 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20201208
```
