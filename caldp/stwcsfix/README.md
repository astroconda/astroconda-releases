...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/stwcsfix/latest-linux.yml
$ conda env create -n caldp_stwcsfix --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_stwcsfix
```
