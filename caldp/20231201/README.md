...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20231201/latest-linux.yml
$ conda env create -n caldp_20231201 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20231201
```
