...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/initialSVM/latest-linux.yml
$ conda env create -n caldp_initialSVM --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_initialSVM
```
