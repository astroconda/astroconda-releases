...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/recovery/latest-linux.yml
$ conda env create -n caldp_recovery --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_recovery
```
