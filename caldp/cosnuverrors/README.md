...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/cosnuverrors/latest-linux.yml
$ conda env create -n caldp_cosnuverrors --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_cosnuverrors
```
