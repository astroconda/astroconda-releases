...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20211129/latest-linux.yml
$ conda env create -n caldp_20211129 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20211129
```
