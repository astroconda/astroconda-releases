...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20220406/latest-linux.yml
$ conda env create -n caldp_20220406 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20220406
```
