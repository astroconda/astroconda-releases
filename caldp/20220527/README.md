...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20220527/latest-linux.yml
$ conda env create -n caldp_20220527 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20220527
```
