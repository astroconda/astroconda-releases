...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20200812/latest-linux.yml
$ conda env create -n caldp_20200812 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20200812
```
