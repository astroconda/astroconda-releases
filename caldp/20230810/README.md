...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20230810/latest-linux.yml
$ conda env create -n caldp_20230810 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20230810
```
