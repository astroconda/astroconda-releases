...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/cosandhap/latest-linux.yml
$ conda env create -n caldp_cosandhap --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_cosandhap
```
