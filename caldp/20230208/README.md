...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20230208/latest-linux.yml
$ conda env create -n caldp_20230208 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20230208
```
