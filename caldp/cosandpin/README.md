...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/cosandpin/latest-linux.yml
$ conda env create -n caldp_cosandpin --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_cosandpin
```
