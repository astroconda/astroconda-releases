...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/dupefreezepkg/latest-linux.yml
$ conda env create -n caldp_dupefreezepkg --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_dupefreezepkg
```
