...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/testPkgFrozen/latest-linux.yml
$ conda env create -n caldp_testPkgFrozen --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_testPkgFrozen
```
