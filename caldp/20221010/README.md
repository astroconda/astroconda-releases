...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20221010/latest-linux.yml
$ conda env create -n caldp_20221010 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20221010
```
