...
```
$ curl -O https://ssb.stsci.edu/releases/caldp/20240509/latest-linux.yml
$ conda env create -n caldp_20240509 --file latest-linux.yml
```
### Activate the pipeline environment

```
$ source activate caldp_20240509
```
